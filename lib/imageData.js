...
const specialPhotos = photos.map((photo) => {
  return {
    id: photo.id,
    title: photo.title,
    url: photo.url,
...
const getSpecialPhotos = (id) => {
  return specialPhotos.find((photo) => photo.id === id);
};

export { getPhotos, getPhotosById, getSpecialPhotos };
